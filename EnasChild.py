...
class FixedEnasChild(nn.Module):
    ...
    def __init__(self, enas_config, num_layers, lr=0.01, keep_prob=0.2, momentum=0.5, num_classes=10, input_shape=28, out_filters=10, num_branches=6, input_channels=3):
